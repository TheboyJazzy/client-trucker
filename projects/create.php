...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        ...
        $stmt->bind_param('isssssd', $clientId, $name, $description, $status, $startDateValue, $endDateValue, $budgetValue);
        $stmt->execute();
        $newId = $stmt->insert_id;
        $stmt->close();

        set_flash('Project added.');
        redirect(base_url('projects/view.php?id=' . $newId));
    }
}
...
<div class="panel">
    <form method="post" action="" novalidate>
        ...
        <div class="form-actions">
            ...
            <a href="<?= base_url('projects/index.php') ?>" class="btn">Cancel</a>
        </div>
    </form>
</div>
